...
class GameColors {
  ...
  static const Color primary = Color(0xFFF9D423);
  static const Color secondary = Color(0xFFFF4E50);
  static const Color accent = Color(0xFFF9C846);
  static const Color success = Color(0xFFEAE374);
  static const Color warning = Color(0xFF2A2A2A);
